...
<video width="800" controls>
  <source src="docs/assets/demo.MOV" type="video/quicktime">
  <source src="docs/assets/demo.MOV" type="video/mp4">
  您的浏览器不支持视频播放。请<a href="docs/assets/demo.MOV" download>点击下载</a>视频文件。
</video>

**💡 提示**：如果视频无法播放，请[点击下载演示视频](docs/assets/demo.MOV)。
